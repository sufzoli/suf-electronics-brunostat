...
TempSensor_Dummy* dummysensor = new TempSensor_Dummy();
...
//	TempSensor_DS18B20 DS1820B_sensor = TempSensor_DS18B20(ONE_WIRE_BUS);
	// TempSensor_Dummy dummysensor = TempSensor_Dummy();
	heater = new GPIOHeater(4);
//	Termostat tempTS(&DS1820B_sensor, &heater, &server,"/settemp");
	Termostat tempTS(dummysensor, heater, &server, "/settemp");
	TS = &tempTS;
...
void setup()
{
	...
	Serial.println("Firmware web update b0006");
}
